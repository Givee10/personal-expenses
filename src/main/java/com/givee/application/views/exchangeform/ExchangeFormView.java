package com.givee.application.views.exchangeform;
...
@PageTitle("Exchange Form")
@Route(value = "exchange-form", layout = MainLayout.class)
@AnonymousAllowed
public class ExchangeFormView extends Composite<VerticalLayout> {
    ...
    public ExchangeFormView() {
        ...
        h3.setText("New exchange");
        h3.setWidth("min-content");
        textField.setLabel("Description");
        textField.setWidth("100%");
        formLayout2Col.setWidth("100%");
        textField2.setLabel("From amount");
        textField2.setWidth("min-content");
        textField3.setLabel("To amount");
