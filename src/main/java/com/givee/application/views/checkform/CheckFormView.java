package com.givee.application.views.checkform;
...
@PageTitle("Check Form")
@Route(value = "check-form", layout = MainLayout.class)
@PermitAll
public class CheckFormView extends Composite<VerticalLayout> {

    public CheckFormView() {
